...
int TMVAClassification_test( TString myMethodList = "" )
{
   ...
   //TTree* background(0);
   //input -> GetObject("background", background);

   std::cout << "2" << std::endl;

   // Create a ROOT output file where TMVA will store ntuples, histograms, etc.
   TString outfileName( "TMVA.root" );//Sozdaet faili =====
 ...
 // To give different trees for training and testing, do as follows:
   ...
   // ```cpp
   // // --- begin ----------------------------------------------------------
   // std::vector<Double_t> vars( 5 ); // vector has size of number of input variables
   //  Float_t  treevars[5], weight;
   //
   // // Signal
   //  for (UInt_t ivar=0; ivar<5; ivar++) signalTree->SetBranchAddress( Form( "var%i", ivar+1 ), &(treevars[ivar]) );
